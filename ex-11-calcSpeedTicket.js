...
// Examples:
//  calcSpeedTicket(20, 50, true)
//  => 300

//  calcSpeedTicket(20, 30, false)
//  => 150

var calcSpeedTicket = function (speedlim, clkspeed, zone) {
    if (clkspeed - speedlim <= 5) {
    return 0;
  } else if ((clkspeed - speedlim < 20) && (zone === true)) {
    return 150 * 2;
  } else if ((clkspeed - speedlim < 20) && (zone === false)) {
    return 150;
  } else if ((clkspeed - speedlim >= 20) && (zone === true)) {
    return 250 * 2;
  } else if ((clkspeed - speedlim >= 20) && (zone === false)) {
